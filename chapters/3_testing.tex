...
I dati in questione hanno attraversato tutti gli step descritti nel capitolo della \ref{ch:methodology}, dal data cleaning fino all'implementazione del DBSCAN.
